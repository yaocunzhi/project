<?php 
	...
	function sendsphone($p){
		...
		$options['accountsid']='b4b7f099c8a84d10a0a14d484becb646';
		//填写在开发者控制台首页上的Auth Token
		$options['token']='b464b8b2a424264faf4be802159d2e29';

		//初始化 $options必填
		$ucpass = new Ucpaas($options);

		$appid = "27f151c9eab34c46a068c9555d19a5c8";	//应用的ID，可在开发者控制台内的短信产品下查看
		$templateid = "490208";    //可在后台短信产品→选择接入的应用→短信模板-模板ID，查看该模板ID
		
		$param = rand(1,1000); //校验码多个参数使用英文逗号隔开（如：param=“a,b,c”），如为参数则留空
