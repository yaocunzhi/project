    ...
    <div id="mws-navigation"> 
     <ul> 
      ...
      <li> <a href="#"><i class="icon-file"></i> 公告管理</a> 
       <ul class="closed"> 
        <li><a href="/dexte/create">公告添加</a></li> 
        <li><a href="/dexte">公告列表</a></li> 
       </ul> </li> 
      <li> <a href="#"><i class="icon-file"></i> 商品管理</a> 
       ...
       <ul class="closed"> 
        <li><a href="/adminlunbo/create">轮播图添加</a></li> 
       ...
       <ul class="closed"> 
        <li><a href="/pingjia/create">评论添加</a></li> 
        <li><a href="/pingjia">评论列表</a></li> 
       </ul> </li> 
         <li> <a href="#"><i class="icon-file"></i> 广告管理</a> 
       <ul class="closed"> 
        <li><a href="/guang/create">广告添加</a></li> 
        <li><a href="/guang">广告列表</a></li> 
       </ul> </li>
     </ul> 
    </div> 
   </div> 
