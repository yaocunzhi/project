 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/dexte/{{$info['id']}}" method="post" enctype="multipart/form-data"> 
     <div class="mws-form-inline"> 
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <input type="text" class="small" name="editor" value="{{$info['editor']}}" /> 
       </div>
      </div> 
        <div class="mws-form-row"> 
       ...
       <div class="mws-form-item">
       <script id="editor" type="text/plain" name="detext" style="width:750px;height:500px;">{!!$info['detext']!!}</script> 
       </div> 
       </div>
      {{csrf_field()}}
