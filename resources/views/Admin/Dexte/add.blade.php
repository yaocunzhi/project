 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/dexte" method="post" enctype="multipart/form-data"> 
     <div class="mws-form-inline"> 
      <div class="mws-form-row"> 
       ...
       <input type="file" class="small"  name="thumb" required="请上传图片"/ >
       </div> 
      </div> 
      <div class="mws-form-row"> 
       <label class="mws-form-label">内容</label> 
       <div class="mws-form-item"> 
        <script id="editor" type="text/plain" name="detext" style="width:750px;height:500px;"> </script> 
       </div> 
      </div> 
      {{csrf_field()}}
