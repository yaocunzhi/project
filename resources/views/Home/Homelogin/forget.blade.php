...
<div class="login-main" style="background-color:#7f7f7f; height: 476px;">
      ...
      <ul class="tabs-nav">
        <li class="j-accountLogin on"><a href="javascript:;">邮箱找回密码<i></i></a></li>
          ...
          <div class="login-content">
              ...
              <div class="account-box" style="display: block">
               <form class="nc-login-form" action="doforget" method="POST" id="find_password_form">
        <input type='hidden' name='formhash' value='SowbREoa3QmZkAVqQEpueMTIsUn6E7O' />       <input type="hidden" name="form_submit" value="ok" />
        <input name="nchash" type="hidden" value="44e012a0" />
                <div class="login-form">
                  
                  <div class="input-inline">
                    <div class="input-icon i-password"></div>
                    <input type="email" class="text" name="email" tipMsg="输入您已注册的邮箱" />
                  </div>
                  
                  <div class="disabled" id="submit-passwd">
                    {{csrf_field()}}
        <input type="submit" site='20' class="login-submit qt-btn btn-green-linear" value="下一步">
          ...
          <form id="post_form" method="post" class="nc-login-form" action="">
            <input type='hidden' name='formhash' value='INKvw4Kby48J20e3r0zJPwJtkGz3qfw' />            <input type="hidden" name="form_submit" value="ok" />
            <input name="nchash" type="hidden" value="44e012a0" />
           ...
           <input name="phone" type="text" class="text" id="phone" tipMsg="可填写已注册的手机号接收短信" autocomplete="off" value="" maxlength="11">
                  ...
                  <div id='sendcode-captcha' class="captcha input-inline" style="display:block">
                    ...
                    <img alt="加载中..."  name="codeimage" id="sms_codeimage" onclick="javascript:document.getElementById('sms_codeimage').src='/static/Home/staticsb/picture/index_1.php' + Math.random();" src="index.php?act=seccode&op=makecode&type=40,100&nchash=44e012a0"  style="margin-left: 10px;vertical-align:middle; cursor:pointer;" /><a class="img-code-a" onclick="javascript:document.getElementById('sms_codeimage').src='index.php?act=seccode&op=makecode&type=40,100&nchash=44e012a0&t=' + Math.random();"></a>
        ...
        <div class="input-inline">
                    <div class="input-icon i-phone"></div>
           <input name="password" type="text" class="text" id="password" tipMsg="输入您的新密码" autocomplete="off" value="">
                  </div>
